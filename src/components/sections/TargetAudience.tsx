...
export default function TargetAudience() {
    return (
        <section className="py-24 md:py-32 bg-brand-dark overflow-hidden relative">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="glass-panel p-8 rounded-2xl border border-white/5 hover:border-brand-purple/30 bg-white/5 backdrop-blur-sm transition-all duration-300">
